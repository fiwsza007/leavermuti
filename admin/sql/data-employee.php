...
$sql4 = "SELECT employees.id,employees.fname,employees.lname,staffstatus.staffid, CONCAT(prefix.prefixname,employees.fname, ' ', employees.lname) AS fullname, 
                employees.department,subdepart.subdepartname,staffstatus.staffname AS staffstatus ,position.positionname,position.positionid,startwork,prefixid,employees.email,employees.pic
         FROM employees 
