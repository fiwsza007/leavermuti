...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "INSERT INTO leavetype (leavetypename, staffid, workage, workageday, leaveofyear, stackleaveday, nameform) 
            VALUES (?, ?, ?, ?, ?, ?, ?)";
    
    $stmt = mysqli_prepare($conn, $sql);
    mysqli_stmt_bind_param($stmt, "siiiiss", $leavetypename, $staffid, $workage, $workageday, $leaveofyear, $stackleaveday, $nameform);
