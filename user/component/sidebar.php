...
<header class="header3" id="header">
    <div class="header__container">
        ...
        <a href="index.php" class="header__logo" style="text-decoration: none;">
            <span class="header__logo">ระบบใบลาป่วย-ลากิจ </span> <i class="ri-mail-unread-fill"></i>
        </a>
            ...
            <div>
                ...
                <div class="sidebar__list">
                    ...
                    if (strpos($position, 'หัวหน้า') !== false || strpos($position, 'ผู้อำนวยการ') !== false):
                        ...
                        leavestatus = 'รอรองผ.อ.อนุมัติ' AND leaves.approver2 = $userID or
                        leavestatus = 'รอผ.อ.อนุมัติ' AND leaves.approver3 = $userID
                        ";
                    ...
                    <?php
                    include('conn/conn.php');
                    $sql_count = "SELECT COUNT(*) as count FROM leaves WHERE employeesid = '$userID' and leavestatus != 'ไม่อนุมัติ'";
                    ...
                    <a href="cancel_leave.php" class="sidebar__link <?php echo (basename($_SERVER['PHP_SELF']) == '#.php') ? 'active-link' : ''; ?>">
                        <i class="ri-delete-back-2-line"></i>
                        <span>ขอยกเลิกการลา</span>
                    </a>

                    <a href="historyleaves.php" class="sidebar__link <?php echo (basename($_SERVER['PHP_SELF']) == '#.php') ? 'active-link' : ''; ?>">
                    ...
                    <a href="leavesday.php" class="sidebar__link <?php echo (basename($_SERVER['PHP_SELF']) == '#.php') ? 'active-link' : ''; ?>">
