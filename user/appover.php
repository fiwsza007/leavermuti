                ...
                <table id="leaveTable" class="table table-striped table-bordered dt-responsive nowrap" style="width:100%">
                    ...
                    <tbody>
                        ...
                        $sql = "SELECT leaves.*, CONCAT(pr.prefixname, e.fname, ' ', e.lname) as fullname, 
                               ...
                               OR leaves.leavestatus = 'รอรองผ.อ.อนุมัติ' AND leaves.approver2 = $userID
                               OR leaves.leavestatus = 'รอผ.อ.อนุมัติ' AND leaves.approver3 = $userID
                               ";
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <button class="btn btn-boder border-danger btn-sm"><i class="ri-close-line"></i> </button>
                                </td>
                            </tr>
                        <?php } ?>
                    </tbody>
