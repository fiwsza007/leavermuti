...
<body>
    ...
    <div class="container text-center mt-5">
        <div class="logo"><img src="login/img/bg.png" alt="" width="200px"></div>
        <h1 class="fw-bold mb-1">ระบบลาป่วย-ลากิจ</h1>
        <p class="text-muted mb-4">มหาวิทยาลัยเทคโนโลยีราชมงคลอีสาน นครราชสีมา</p>
